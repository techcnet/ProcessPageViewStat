...
// General
    ...
    $field->label2 = __('Enable');
    $field->description = __('Logs informations into a log file which can help to troubleshoot problems.');
...
// IP2Location
    ...
    $field = $this->modules->get('InputfieldText');
    $field->name = 'iploc_token';
    $field->label = __('Token');
    $field->description = __('In order to get the geo location from the IP address and show the location on a map you have to create an account with the FREE version of IP2Location (https://lite.ip2location.com). Paste the token in the field below.');
    $temp = "\n".__('DB5LITEBINIPV6 database file time: ');
    if (file_exists(__DIR__.'/iploc/IP2LOCATION-LITE-DB5.IPV6.BIN')) {
      $temp .= date("F d Y H:i:s", filemtime(__DIR__.'/iploc/IP2LOCATION-LITE-DB5.IPV6.BIN')).' (UTC)';
    } else {
      $temp .= __('File not exists.');
    }
    $field->notes = $temp;
...
// About
    ...
    $field->value = '<p style="text-align:center">'.__('This module uses:').'<br />';
    $field->value .= '<a target="_blank" href="https://www.ip2location.com/">IP2Location</a><br />';
    $field->value .= '<a target="_blank" href="http://github.com/asvd/dragscroll">dragscroll</a><br />';
    $field->value .= '<a target="_blank" href="https://github.com/donatj/PhpUserAgent">PhpUserAgent</a><br />';
    $field->value .= '<a target="_blank" href="https://www.openstreetmap.org/">OpenStreetMap</a>';
    $field->value .= '</p>';

    $field->value .= '<p style="text-align:center">';
    $field->value .= 'ProcessPageViewStat @ <a href="https://modules.processwire.com/modules/process-page-view-stat/">processwire.com</a><br />';
    $field->value .= 'ProcessPageViewStat @ <a href="https://github.com/techcnet/ProcessPageViewStat">github.com</a><br />';
    $field->value .= 'ProcessPageViewStat @ <a href="https://tech-c.net/posts/page-view-statistic-for-processwire/">tech-c.net</a>';
    $field->value .= '</p>';

    $field->value .= '<p style="text-align:center">';
    $field->value .= '<a target="_blank" href="https://tech-c.net/donation/"><img style="margin:auto;" src="'.wire('config')->urls->siteModules.'ProcessPageViewStat'.'/images/donate.png" /></a>';
    $field->value .= '</p>';

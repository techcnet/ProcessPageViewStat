...
// Records
    ...
    $field->description = __('Opens the specified Whois service page when clicking on the IP address. Note the place holder %s for the IP address.');
    $fieldset->add($field);
...
// About
    ...
    $field = $this->modules->get('InputfieldMarkup');
    $field->value = '<p style="text-align:center">'.__('This module uses:').' <a target="_blank" href="https://www.ip2location.com/">IP2Location</a>, <a target="_blank" href="http://github.com/asvd/dragscroll">dragscroll</a> and <a target="_blank" href="https://www.toms-world.org/blog/parseuseragentstring/">parseUserAgentStringClass</a>.</p>

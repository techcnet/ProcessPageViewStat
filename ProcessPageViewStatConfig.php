...
// Whois
    ...
    $field = $this->modules->get('InputfieldCheckbox');
    $field->name = 'show_map';
    $field->label = __('Show map');
    $field->label2 = __('Enable');
    $field->description = __('Shows a map with the location of the IP address.');
    $field->notes = 'The location is determined using the free service geoPlugin (www.geoplugin.com). The map will be generated with layers from OpenStreetMap (www.openstreetmap.org).';
    $field->attr('name', 'show_map');
    $fieldset->add($field);
...
// About
    ...
    $field->value .= '<a target="_blank" href="https://www.geoplugin.com/">geoPlugin</a><br />';
